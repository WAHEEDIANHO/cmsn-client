...
class CriminalProfile extends React.Component {
  ...
  updateCriminal(e) {
    console.log("from update", this.state.criminal);
    this.setState({ loading: true });

    const { id } = e.target.dataset;
    // console.log(id, this.state.criminal);
    axios
      ...
      .then((res) => {
        Swal.fire({
          position: 'top-end',
          icon: 'success',
          title: 'Criminal updated successfully',
      ...
      .catch((err) => {
        Swal.fire({
          ...
          icon: 'error',
          title: "Ooops!",
          text: 'error while updating criminal',
          showConfirmButton: false,
          timer: 1500
        })
        console.log(err)
                ...
                <div className="d-flex flex-column align-items-center text-center p-3 py-5 ">
                  ...
                  <div className="row mt-3 align-items-center">
                    <div className="col-md-4">
                      <label htmlFor="nok_rel" className="form-label m-0">
                        Discharge
                      </label>
                    </div>
                    <div className="col-md-8">
                      <div className="btn-group my-2">
                        <input type="radio"
                               ...
                               defaultChecked={criminal.discharge}
                        />
                        <label className="btn btn-danger" htmlFor="option1">Yes</label>
                        ...
                        <input type="radio"
                               ...
                               defaultChecked={!criminal.discharge}
                        />
                        <label className="btn btn-danger" htmlFor="option2">No</label>
